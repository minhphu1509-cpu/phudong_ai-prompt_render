...
const visualFilters = (discipline: Discipline): QuickFilter[] => [
  ...
  { key: 'aspect', label: 'Tỷ lệ ảnh', options: list(
    '3:2 ngang (Chuẩn DSLR kiến trúc)',
    '16:9 ngang (Màn hình / TV / Trình chiếu)',
    '4:3 ngang (Catalog / Báo cáo dự án)',
    '1:1 vuông (Portfolio / Mạng xã hội)',
    '2:3 dọc (Poster kiến trúc / Đứng)',
    '9:16 dọc (Story / TikTok / Reels)',
    '3:4 dọc (Bìa hồ sơ / Tranh đứng)',
    '4:5 dọc (Chân dung / Instagram)',
    '21:9 ngang (Panorama toàn cảnh)',
    '5:4 ngang (Mỹ thuật khổ lớn)',
  ) },
